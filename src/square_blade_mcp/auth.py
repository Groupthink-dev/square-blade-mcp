...
Bearer token auth for remote/tunnel access. Set ``SQUARE_MCP_API_TOKEN`` env var.
...
def get_bearer_token() -> str | None:
    ...
    token = os.environ.get("SQUARE_MCP_API_TOKEN", "").strip()
...
class BearerAuthMiddleware:
    ...
    When ``SQUARE_MCP_API_TOKEN`` is set, every request must carry a matching
